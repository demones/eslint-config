...
/**
 * eslint rules 整理，基于 eslint v5.11.0，eslint-plugin-react v7.11.1，eslint-plugin-import v2.14.0 eslint-plugin-jsx-a11y v6.1.2 后续会持续升级的
...
module.exports = {
  "rules": {
    ...
    "import/prefer-default-export": 2, // 只有一个到处时，优先用 default 写法
    ...
    "react/jsx-one-expression-per-line": [2, { "allow": "single-child" }], // 每个表达式应该写在一行
    ...
    "jsx-a11y/anchor-is-valid": [2, { // 规范 a 标签的写法
      "components": ["Link"],
      "specialLink": ["to"],
